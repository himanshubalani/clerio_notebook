...
/**
 * Enqueue a job telling the worker to index a source.
 * @param {{ filePath: string, originalName: string, mimeType: string, size: number, sourceId?: string, conversationId?: string, youtubeUrl?: string, websiteUrl?: string, videoId?: string }} payload
 */
